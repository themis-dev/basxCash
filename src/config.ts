...
const configurations: { [env: string]: Configuration } = {
  development: {
    ...
    externalTokens: {
      ...
      HETH: ['0xae3a768f9ab104c69a7cd6041fe16ffa235d1810', 18],
    ...
    bankLaunchesAt: new Date('2021-01-11T10:00:00Z'),
    bondLaunchesAt: new Date('2021-01-20T22:00:00Z'),
    boardroomLaunchesAt: new Date('2021-01-20T22:00:00Z'),
